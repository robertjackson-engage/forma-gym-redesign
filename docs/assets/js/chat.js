...
(function () {
  ...
  var SYSTEM = [
    ...
    "- Recovery: Cryotherapy + Cold Plunge (chamber to -195°F, 3-min sessions burn 500-800 cal, reduce pain/inflammation, better sleep). Full-service Spa (massage from $65/25min to $160/80min; facials $140-$230; add-ons CBD $10, hot stone $20). DrBrainRX (brain health). Sauna, eucalyptus steam, hot tub.",
